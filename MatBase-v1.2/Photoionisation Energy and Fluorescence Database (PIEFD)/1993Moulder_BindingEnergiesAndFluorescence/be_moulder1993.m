function [be, cls] = be_moulder1993(element, corelevel, plot_results)
...
ATOM_SYMB   = BE_DB_Moulder1993.ATOM_SYMB;
ATOM_CL     = BE_DB_Moulder1993.ATOM_CL;
ATOM_BE     = BE_DB_Moulder1993.BE;
...
if plot_results == 1
    ...
    title('Moulder 1993 - Binding Energy (eV)');
