function [be, cls] = be_cant2022(element, corelevel, plot_results)
...
%   with Z from 1 to 92 of the individual subshells. This is from the original
...
ATOM_SYMB   = BE_DB_Cant2022.ATOM_SYMB;
ATOM_CL     = BE_DB_Cant2022.ATOM_CL;
ATOM_BE     = BE_DB_Cant2022.BE;
...
if plot_results == 1
    ...
    title('Cant 2022 - Binding Energy (eV)');
