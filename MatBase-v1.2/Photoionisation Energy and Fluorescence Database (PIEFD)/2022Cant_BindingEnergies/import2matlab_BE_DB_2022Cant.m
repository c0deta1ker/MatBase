...
path_data       = path_matbase + "\MatBase-v1.2\Photoionisation Energy and Fluorescence Database (PIEFD)\2022Cant_BindingEnergies\data\";
path_data_save  = path_matbase + "\MatBase-v1.2\Photoionisation Energy and Fluorescence Database (PIEFD)\2022Cant_BindingEnergies\";
path_fig_save   = path_matbase + "\MatBase-v1.2\Photoionisation Energy and Fluorescence Database (PIEFD)\2022Cant_BindingEnergies\figs_be\";
...
close all;
for i = ATOM_ZNUM
    be_cant2022(ATOM_SYMB{i}, [], 1); print(path_fig_save + sprintf("Z%i_%s_BE", ATOM_ZNUM(i), ATOM_SYMB{i}),'-dpng', '-r500');
    close all;
end