...
fontSize = 20;
lineWidth = 2.;
%% 1 - Defining the polygons of the truncated octahedron
...
%% 2 - Defining the polygons of the right-sqaure pyramids
...
%% 3 - Plotting the truncated octahedron Brilluoin zone
hold on;
