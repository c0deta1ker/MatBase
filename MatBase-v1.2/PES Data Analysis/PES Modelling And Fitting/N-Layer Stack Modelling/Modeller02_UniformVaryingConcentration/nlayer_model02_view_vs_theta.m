function fig = nlayer_model02_view_vs_theta(pes_model)
...
for i = 1:pes_model.Nlyrs
    for j = 1:length(pes_model.lyr_conc{i})
        plot(pes_model.theta, pes_model.lyr_Inorm{i}{j}, 'k.-', 'color', lyr_cols{i}./j, 'markerfacecolor', lyr_cols{i}./j, 'linewidth', 2.5);
