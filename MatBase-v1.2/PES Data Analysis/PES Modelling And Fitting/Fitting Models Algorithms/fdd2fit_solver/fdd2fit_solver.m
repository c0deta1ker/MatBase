...
if plot_result == 1
    ...
    text(0.04, 0.27, "$$ E_F = $$ " + string(round(fitStr.EF,3)) + " eV", 'interpreter', 'latex', 'fontsize', 12, 'color', 'k', 'Units','normalized');
    text(0.04, 0.19, "$$ \Delta E = $$ " + string(round(fitStr.FWHM,3)) + " eV", 'interpreter', 'latex', 'fontsize', 12, 'color', 'k', 'Units','normalized');
