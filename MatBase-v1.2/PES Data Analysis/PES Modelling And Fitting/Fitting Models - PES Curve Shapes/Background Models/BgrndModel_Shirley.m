function [roi_xdat, roi_ydat, roi_bgrnd] = BgrndModel_Shirley(xdat, ydat, LHS, RHS, Win)
% [roi_xdat, roi_ydat, roi_bgrnd] = BgrndModel_Shirley(xdat, ydat, LHS, RHS, Win)
%   Function that determines the best fit to the background of PES (or 1D) 
%   data using an Iterative Shirley background. 
%
%   IN:
