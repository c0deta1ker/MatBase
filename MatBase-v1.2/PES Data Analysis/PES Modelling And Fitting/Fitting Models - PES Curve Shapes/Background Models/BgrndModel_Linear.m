function [roi_xdat, roi_ydat, roi_bgrnd] = BgrndModel_Linear(xdat, ydat, LHS, RHS, Win)
% [roi_xdat, roi_ydat, roi_bgrnd] = BgrndModel_Linear(xdat, ydat, LHS, RHS, Win)
%   Function that determines the best fit to the background of PES (or 1D) 
%   data using a linear function. 
%   
%   IN: 
...
%% - 4 - Determination of the Linear Background
% -- Fitting the data to a polynomial of the correct order
fitResult           = fit(xdat_bgrnd, ydat_bgrnd, 'poly1');
