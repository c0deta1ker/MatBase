function y = TopHatModel_Exp_RHS_trunc(x, center, amplitude, width, cdl, cutoff)
% y = TopHatModel_Exp_RHS_trunc(x, center, amplitude, width, cdl, cutoff)
...
y = TopHatModel_Exp_RHS(x, center, amplitude, width, cdl);
