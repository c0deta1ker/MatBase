function y = TopHatModel_Gauss_RHS_trunc(x, center, amplitude, width, fwhm, cutoff)
% y = TopHatModel_Gauss_RHS_trunc(x, center, amplitude, width, fwhm, cutoff)
...
y = TopHatModel_Gauss_RHS(x, center, amplitude, width, fwhm);
