function y = StepModel_Gauss_LHS(x, center, amplitude, fwhm)
% y = StepModel_Gauss_LHS(x, center, amplitude, fwhm)
...
%   amplitude (I0) and full-width at half-maximum (fwhm) can 
