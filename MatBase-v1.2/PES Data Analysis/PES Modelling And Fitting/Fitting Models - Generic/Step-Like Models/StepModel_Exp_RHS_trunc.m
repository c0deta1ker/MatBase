function y = StepModel_Exp_RHS_trunc(x, center, amplitude, cdl, cutoff)
% y = StepModel_Exp_RHS_trunc(x, center, amplitude, cdl, cutoff)
...
y = StepModel_Exp_RHS(x, center, amplitude, cdl);
