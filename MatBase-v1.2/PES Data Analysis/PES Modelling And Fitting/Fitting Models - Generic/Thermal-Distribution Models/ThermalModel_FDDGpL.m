function y = ThermalModel_FDDGpL(x, center, temperature, width, linear_slope, linear_intercept, constant_bgrnd)
% y = ThermalModel_FDDGpL(x, center, temperature, width, linear_slope, linear_intercept, constant_bgrnd)
...
%   MULTIPLIED to account for any linear distortion of the Fermi-edge; 
