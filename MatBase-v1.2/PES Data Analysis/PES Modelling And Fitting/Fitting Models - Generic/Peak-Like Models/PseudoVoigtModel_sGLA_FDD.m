function y = PseudoVoigtModel_sGLA_FDD(x, center, amplitude, width, mixratio, asymmetry, fdd_center, fdd_temperature, fdd_width)
% y = PseudoVoigtModel_sGLA_FDD(x, center, amplitude, width, mixratio, asymmetry, fdd_center, fdd_temperature, fdd_width)
%   A model based on an asymmetric pseudo-sum Voigt distribution function
...
int_sGLA  	= PseudoVoigtModel_sGLA(x, center, amplitude, width, mixratio, asymmetry);
...
if ~isequal(size(int_FDDG), size(int_sGLA)); int_FDDG = int_FDDG'; end
y        = int_FDDG .* int_sGLA; 
y        = amplitude .* y / max(y);
