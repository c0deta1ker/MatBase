function y = PseudoVoigtModel_pGLA(x, center, amplitude, width, mixratio, asymmetry)
% y = PseudoVoigtModel_pGLA(x, center, amplitude, width, mixratio, asymmetry)
%   A model based on an asymmetric pseudo-product Voigt distribution function. The model 
...
int_pGL     = PseudoVoigtModel_pGL(x, center, amplitude, width, mixratio);
...
y        = int_pGL + int_AEB .* (max(int_pGL(:)) - int_pGL);
