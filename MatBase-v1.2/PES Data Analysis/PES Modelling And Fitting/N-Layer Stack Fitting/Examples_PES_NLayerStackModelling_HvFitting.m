...
close all;
nlayer2pes_full_hv_solver_view_init(xpsDat, modelDat, iparams);
%% 1.3    :   Running the optimization algorithm
close all; 
solve_type = 'fmincon';
fitStr_01 = nlayer2pes_full_hv_solver(xpsDat, modelDat, iparams, solve_type); fitStr_01
nlayer2pes_full_hv_solver_view_fit(fitStr_01);
%% 1.4    :   Running the optimization algorithm and finding the best solution after 10 runs
close all; 
solve_type = 'fmincon';
n_runs = 10;
[fitStr_02, statStr_02] = nlayer2pes_full_hv_solver_n_runs(xpsDat, modelDat, iparams, solve_type, n_runs); fitStr_02
nlayer2pes_full_hv_solver_view_fit(fitStr_02);
statStr_02
...
xpsDat.ydat     = xpsDat.ydat ./ sum(xpsDat.ydat, 2);
...
% -- Preview the initial conditions of the model vs data
close all;
nlayer2pes_partial_hv_solver_view_init(xpsDat, modelDat, iparams, which_layers);
%% 2.3    :   Running the optimization algorithm
close all; 
solve_type = 'fmincon';
fitStr_03 = nlayer2pes_partial_hv_solver(xpsDat, modelDat, iparams, which_layers, solve_type); fitStr_03
nlayer2pes_partial_hv_solver_view_fit(fitStr_03);
%% 2.4    :   Running the optimization algorithm and finding the best solution after 10 runs
close all; 
solve_type = 'fmincon';
n_runs = 10;
[fitStr_04, statStr_04] = nlayer2pes_partial_hv_solver_n_runs(xpsDat, modelDat, iparams, which_layers, solve_type, n_runs);
nlayer2pes_partial_hv_solver_view_fit(fitStr_04);
statStr_04