function fig = nlayer2pes_partial_hv_solver_view_init(xpsDat, modelDat, iparams, which_layers)
% fig = nlayer2pes_partial_hv_solver_view_init(xpsDat, modelDat, iparams, which_layers)
...
MM = MM(:,which_layers); MM = MM ./ sum(MM, 2);
