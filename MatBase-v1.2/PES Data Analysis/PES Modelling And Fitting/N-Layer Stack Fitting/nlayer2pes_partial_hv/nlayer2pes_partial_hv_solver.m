function fitStr = nlayer2pes_partial_hv_solver(xpsDat, modelDat, iparams, which_layers, solve_type)
% fitStr = nlayer2pes_partial_solver(xpsDat, modelDat, iparams, which_layers, solve_type)
...
function MINFUN = minimize_function(x, XPSObj)
    ...
    % - 3 - Extracting the RESIDUALS (residuals = data - model))
    R       = D - M;
