function [fitStr0, statStr] = nlayer2pes_full_hv_solver_n_runs(xpsDat, modelDat, iparams, solve_type, n_runs)
...
for i = statStr.n_runs
    ...
    % --- Executing the fit
    if i == 1;  fitStr{1} = nlayer2pes_full_hv_solver(xpsDat, modelDat, iparams, solve_type);
    else;       fitStr{i} = nlayer2pes_full_hv_solver(xpsDat, modelDat, new_init_conds, solve_type);
    end
