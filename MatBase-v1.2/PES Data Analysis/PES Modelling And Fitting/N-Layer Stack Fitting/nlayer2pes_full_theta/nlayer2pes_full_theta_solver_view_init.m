function fig = nlayer2pes_full_theta_solver_view_init(xpsDat, modelDat, iparams)
% fig = nlayer2pes_full_theta_solver_view_init(xpsDat, modelDat, iparams)
...
%   the photoelectron intensities against emission angle; (3) A plot of the 
...
title('Photoelectron intensities vs emission angle');
