function fig = nlayer2pes_partial_theta_solver_view_fit(fitStr)
% fig = nlayer2pes_partial_theta_solver_view_fit(fitStr)
...
which_layers    = fitStr.which_layers;
...
for i = 1:length(which_layers)
    ...
    leg_labels{i}   = string(fitStr.opt_pes_model.lyr_mat{which_layers(i)})+"("+string(fitStr.opt_pes_model.lyr_cls{which_layers(i)})+")";
