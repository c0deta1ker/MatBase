function xsect_sigma = xsect_sigma_yehlind1985(element, corelevel, hv, plot_results)
...
if plot_results == 1
    ...
    title('Yeh & Lindau 1985 - Photoionisation Cross Section (sigma)');
