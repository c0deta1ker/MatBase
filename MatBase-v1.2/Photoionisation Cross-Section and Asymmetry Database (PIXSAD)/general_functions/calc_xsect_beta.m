function xsect_beta = calc_xsect_beta(element, corelevel, hv, formalism, plot_results)
% xsect_beta = calc_xsect_beta(element, corelevel, hv, formalism, plot_results)
...
%   -   formalism:      string of the photoionization cross-section formalism to use. Default:"Cant2022" ["Cant2022","YehLindau1985","Trzhaskovskaya2018","Cant2022"]
...
if strcmpi(formalism, "Scofield1973") || strcmpi(formalism, "Sco") || strcmpi(formalism, "S") || strcmpi(formalism, "1973")  || strcmpi(formalism, "S1973")
    xsect_beta = []; msg = 'The dipole asymmetry parameter beta is not available in the Scofield1973 database. Beta set to zero.'; 
    % disp(msg);
...
elseif strcmpi(formalism, "Trzhaskovskaya2018") || strcmpi(formalism, "Trz") || strcmpi(formalism, "T") || strcmpi(formalism, "2018")  || strcmpi(formalism, "T2018")
    xsect_beta = xsect_beta_trzh2018(element, corelevel, hv, plot_results);
% -- Cant2020 formalism
