function xsect_delta = calc_xsect_delta(element, corelevel, hv, formalism, plot_results)
% xsect_delta = calc_xsect_delta(element, corelevel, hv, formalism, plot_results)
...
if strcmpi(formalism, "Scofield1973") || strcmpi(formalism, "Sco") || strcmpi(formalism, "S") || strcmpi(formalism, "1973")  || strcmpi(formalism, "S1973")
    xsect_delta = []; msg = 'The non-dipole asymmetry parameter delta is not available in the Scofield1973 database. Delta is empty.'; 
    % disp(msg);
...
elseif strcmpi(formalism, "YehLindau1985") || strcmpi(formalism, "Yeh") || strcmpi(formalism, "Lindau") || strcmpi(formalism, "YL") || strcmpi(formalism, "1985")  || strcmpi(formalism, "YL1985")
    xsect_delta = []; msg = 'The non-dipole asymmetry parameter delta is not available in the YehLindau1985 database. Delta is empty.'; 
    % disp(msg);
