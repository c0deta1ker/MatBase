function xsect_sigma = calc_xsect_sigma(element, corelevel, hv, formalism, plot_results)
% xsect_sigma = calc_xsect_sigma(element, corelevel, hv, formalism, plot_results)
...
elseif strcmpi(formalism, "YehLindau1985") || strcmpi(formalism, "Yeh") || strcmpi(formalism, "Lindau") || strcmpi(formalism, "YL") || strcmpi(formalism, "1985")  || strcmpi(formalism, "YL1985")
    xsect_sigma = xsect_sigma_yehlind1985(element, corelevel, hv, plot_results);
...
elseif strcmpi(formalism, "Trzhaskovskaya2018") || strcmpi(formalism, "Trz") || strcmpi(formalism, "T") || strcmpi(formalism, "2018")  || strcmpi(formalism, "T2018")
    xsect_sigma = xsect_sigma_trzh2018(element, corelevel, hv, plot_results);
% -- Cant2020 formalism
