function xsect_sigma = xsect_sigma_trzh2018(element, corelevel, hv, plot_results)
...
XSECT       = XS_DB_Trzh2018.XSECT_SIGMA;
...
if plot_results == 1
    ...
    title('Trzh. & Yarz. 2018 - Photoionisation Cross Section (sigma)');
