function xsect_beta = xsect_beta_trzh2018(element, corelevel, hv, plot_results)
...
XSECT       = XS_DB_Trzh2018.XSECT_BETA;
...
if plot_results == 1
    ...
    title('Trzh. & Yarz. 2018 - Photoionisation Parameter (beta)');
